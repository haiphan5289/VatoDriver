...
final class TODetailLocationInteractor: PresentableInteractor<TODetailLocationPresentable>, ActivityTrackingProgressProtocol {
    ...
    func getLocationInfo() {
        ...
        let stationDetailUrl = TOManageCommunication.Configs.url("/taxi/pickup-stations/\(pickupStationId)")
        ...
        let listDriverUrl = TOManageCommunication.Configs.url("/taxi/pickup-stations/\(pickupStationId)/drivers")
